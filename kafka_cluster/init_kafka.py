from config.config import INIT_CLIENT_CONFIG, RAW_MSG_TOPIC, MSG_WITH_EMBEDDINGS_TOPIC, PARTITIONS_NUM, REPLICATION_FACTOR_NUM, MSG_WITH_REDUCED_EMBEDDINGS_TOPIC
...
topics_to_create = [
    ...
    NewTopic(topic=MSG_WITH_REDUCED_EMBEDDINGS_TOPIC, num_partitions=PARTITIONS_NUM, replication_factor=REPLICATION_FACTOR_NUM),
]
